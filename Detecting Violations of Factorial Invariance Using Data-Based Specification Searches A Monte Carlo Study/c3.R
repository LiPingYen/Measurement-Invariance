...
for(i in 1:reps){
  assign(paste0("dta3_", i), data.frame(gen_dta_v6(nobs = nobs,la1=lambda1_1,la2 = lambda2_3,
                                                phi1 = phi1,phi2 = phi2,
                                                th2 = theta2_3)))
}

dta_list = mget(apropos("dta3_"))
md<-"
...
for(i in 1:reps){
  assign(paste0("dta3_", i), data.frame(gen_dta_v12(nobs = nobs,la1=lambda1_1,la2 = lambda2_3,
                                                phi1 = phi1,phi2 = phi2,
                                                th2 = theta2_3)))
}
