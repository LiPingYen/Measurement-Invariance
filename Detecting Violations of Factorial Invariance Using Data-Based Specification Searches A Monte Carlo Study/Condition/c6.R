...
data.frame(mean = mean(rmsea_all_c6_n200),
           sd = sd(rmsea_all_c6_n200))
...
data.frame(mean = mean(rmsea_all_c6_n500),
           sd = sd(rmsea_all_c6_n500))
...
phi1 <- 1
lambda2_6 <-
  matrix(c(0.4, 0.51, 0.5, 0.34, 0.46, 0.3, 0.4, 0.51, 0.5, 0.34, 0.46, 0.3),
         nrow = 12)
phi2 <- 1.3
