...
for(i in 1:reps){
  assign(paste0("dta5_", i), data.frame(gen_dta_v6(nobs = nobs,la1=lambda1_1,la2 = lambda2_5,
                                                phi1 = phi1,phi2 = phi2,
                                                th2 = theta2_5)))
}

dta_list = mget(apropos("dta5_"))
md<-"
...
for(i in 1:reps){
  assign(paste0("dta5_", i), data.frame(gen_dta_v12(nobs = nobs,la1=lambda1_1,la2 = lambda2_5,
                                                phi1 = phi1,phi2 = phi2,
                                                th2 = theta2_5)))
}
