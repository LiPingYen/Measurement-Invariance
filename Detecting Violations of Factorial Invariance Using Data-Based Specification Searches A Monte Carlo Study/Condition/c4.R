...
for(i in 1:reps){
  assign(paste0("dta4_", i), data.frame(gen_dta_v6(nobs = nobs,la1=lambda1_1,la2 = lambda2_4,
                                                phi1 = phi1,phi2 = phi2,
                                                th2 = theta2_4)))
}

dta_list = mget(apropos("dta4_"))
md<-"
...
for(i in 1:reps){
  assign(paste0("dta4_", i), data.frame(gen_dta_v12(nobs = nobs,la1=lambda1_1,la2 = lambda2_4,
                                                phi1 = phi1,phi2 = phi2,
                                                th2 = theta2_4)))
}
