...
data.frame(mean = mean(rmsea_all_c1_n200),
           sd = sd(rmsea_all_c1_n200))
...
data.frame(mean = mean(rmsea_all_c1_n500),
           sd = sd(rmsea_all_c1_n500))
...
phi1 <- 1
lambda2_1 <-
  matrix(c(0.6, 0.77, 0.5, 0.6, 0.8, 0.3, 0.6, 0.77, 0.5, 0.6, 0.8, 0.3), nrow = 12)
phi2 <- 1.3
