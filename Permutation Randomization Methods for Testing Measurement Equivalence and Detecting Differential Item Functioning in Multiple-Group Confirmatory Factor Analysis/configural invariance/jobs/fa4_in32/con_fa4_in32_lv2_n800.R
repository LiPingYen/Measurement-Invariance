...
#model
#null model
null_md <- c(paste0("X", 1:32, " ~~ c(psi", 1:9, ",psi", 1:9, ")*X", 1:32),
...
#group2
#level2
lambda2 <- matrix(c(0.54,-0.03,-0.02,-0.11,
                    0.62,0.02,-0.03,-0.03,
                    0.6,-0.04,-0.03,0,
                    0.61,0,-0.01,0.08,
                    0.7,0.61,0.07,0,
...
per_rej_rate<-per_rej_rate(data = per_afi_list, pvalue = pvalue)#configural invariance
#indicator=32, factor= 4
