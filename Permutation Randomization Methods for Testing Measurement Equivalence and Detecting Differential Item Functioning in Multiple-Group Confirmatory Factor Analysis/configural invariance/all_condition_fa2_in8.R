...
null_md <-
  c(
    paste0("X", 1:8, " ~~ c(psi", 1:8, ",psi", 1:8, ")*X", 1:8),
    paste0("X", 1:8, " ~ c(tau", 1:8, ", tau", 1:8, ")*1")
  )
...
lambda1 <- matrix(c(0.68,-0.03,
                    ...
                    -0.06,0.56,
                    -0.08,0.75,
                    -0.02,0.72), nrow = 8, ncol = n_factor, byrow = TRUE)
